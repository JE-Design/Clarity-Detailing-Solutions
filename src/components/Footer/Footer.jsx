...
const Footer = () => {
  return (
    <footer className="flex flex-col w-full">
      <div id="top" className="flex items-center flex-col sm:flex-row w-full">
        ...
        <div className="flex w-4/12">
          <Link to="/" className="m-auto w-4/6 sm:w-40">
            <img src={logo_image} alt="Clarity Detailing Solutions Logo" />
          </Link>
        </div>
        <div
          id="contact"
        ...
        >
          ...
          <p className="sm:text-right w-full p-1">New York, NY 10030</p>
